...
import { StudioControlsPanel } from "./control-panel";
import { StudioPreviewPanel } from "./preview-panel";
import { HistoryPreviewDialog } from "./history-preview-dailog";

const StudioWorkbench = ({ clerkUserId, initialHistory, initialQuota }: StudioWorkbenchProps) => {
  return (
